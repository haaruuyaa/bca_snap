...
class BcaSnapRepositories
{
    ...
    {
        return BcaTransactionLog::where('trx_id', $trxId)->first();
    }
    ...
    public function insert(array $data): void
    {
        ...
        BcaTransactionLog::create($insertProperties);
    }
    ...
    public function update(array $data, string $refNo = null): void
    {
        ...
        $transaction = BcaTransactionLog::where('trx_id', $trxId)->first();
        ...
        $transaction->response_msg = $data['responseMessage'];
